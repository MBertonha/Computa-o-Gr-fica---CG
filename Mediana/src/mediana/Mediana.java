...
public class Mediana {
    ...
    public static void escalaDeCinza(BufferedImage img,int[][] matrizAux) {
    ...
    public static void executionMediana(BufferedImage img) throws IOException{
        ...
        String outPut = "C:\\Users\\berto\\OneDrive\\Área de Trabalho\\UENP - 2019\\Computação Gráfica\\imageMediana.jpg";
