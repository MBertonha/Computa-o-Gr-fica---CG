...
public class Morfologias {
	...
	public static BufferedImage funcaoDilatar(BufferedImage img) {
		...
		try {
			String outPut = "C:\\Users\\berto\\OneDrive\\Área de Trabalho\\UENP - 2019\\Computação Gráfica\\imgDilatada.jpg";
	...
	public static BufferedImage funcaoErodir(BufferedImage imagem) {
		...
		try {
			String outPut = "C:\\Users\\berto\\OneDrive\\Área de Trabalho\\UENP - 2019\\Computação Gráfica\\imgErodida.jpg";
                        File out = new File(outPut);
	...
	public static void main(String[] args) {
            try{
            File f = new File("C:\\Users\\berto\\OneDrive\\Área de Trabalho\\UENP - 2019\\Computação Gráfica\\S.jpg");
