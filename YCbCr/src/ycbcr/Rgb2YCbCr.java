...
public class Rgb2YCbCr{
    ...
    public static void execution(BufferedImage img) throws IOException{
        ...
        int cont =0;
         ...
         File out = new File("C:\\Users\\berto\\OneDrive\\Área de Trabalho\\UENP - 2019\\Computação Gráfica\\Y.jpg");
         ImageIO.write(redImage, "JPG", out);
              out = new File("C:\\Users\\berto\\OneDrive\\Área de Trabalho\\UENP - 2019\\Computação Gráfica\\Cb.jpg");
         ImageIO.write(greenImage, "JPG", out);
              out = new File("C:\\Users\\berto\\OneDrive\\Área de Trabalho\\UENP - 2019\\Computação Gráfica\\Cr.jpg");
